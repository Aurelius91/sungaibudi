			...
			<div class="row row-eq-height">
				...
				<div class="col-sm-6 home-about-wrap">
					<div class="home-about-inside">
						...
						<div class="home-about-video-wrap fade-animate" data-animate data-animation-classes="animated fadeInRight" style="background-image: url(<?= base_url(); ?>assets/images/main/home-about-video.jpg);">
