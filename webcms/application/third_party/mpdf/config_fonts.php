...
$this->fontdata = array(
    "aleo" => array(
        'LI' => "aleo-lightitalic-webfont.ttf",
        'L' => "aleo-light-webfont.ttf",
        'R' => "aleo-regular-webfont.ttf",
        'BI' => "aleo-bolditalic-webfont.ttf",
        'I' => "aleo-italic-webfont.ttf",
        'B' => "aleo-bold-webfont.ttf",
        'useOTL' => 0xFF,
        'useKashida' => 75,
    ),
    ...
    "gothambook" => array(
        'R' => "GothamNarrow-Book.ttf",
        ),
    "gothammedium" => array(
        'R' => "GothamNarrow-Medium.ttf",
        ),
