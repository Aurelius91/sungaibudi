	...
	<script type="text/javascript">
		...
		function back() {
			window.location.href = '<?= base_url(); ?>corporate/view/1/';
		}
		...
		function init() {
			tinymce.init({
				selector: 'textarea#corporate-content',
				height: 300,
				width: '100%',
		...
		function reset() {
			$('#corporate-name').val("<?= $corporate->name; ?>");
			...
			var image = '<img class="preview" src="<?= base_url(); ?>images/website/<?= $corporate->image_name; ?>">';
			$('#preview').append(image);
		}

		function submit() {
			var corporateName = $('#corporate-name').val();
			...
			$.ajax({
				...
				type : 'POST',
				url : '<?= base_url() ?>corporate/ajax_edit/<?= $corporate->id; ?>/',
				xhr: function() {
					var percentage = 0;
					var xhr = new window.XMLHttpRequest();
		...
		<div class="ui stackable one column centered grid">
			<div class="column">
				<div class="ui attached message setting-header">
					<div class="header">Add Corporate</div>
				</div>
				<div class="form-content">
					<div class="ui form">
						<h4 class="ui dividing header">Corporate Detail</h4>
						<div class="field">
							<label>Name <span class="color-red">*</span></label>
							<input id="corporate-name" class="form-input data-important" placeholder="Name.." type="text">
						</div>
						...
						<div class="three fields">
							<div class="field">
								...
								<div>Recommended Size: 800px x 360px</div>
