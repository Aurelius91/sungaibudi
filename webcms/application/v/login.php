...
<body>
	...
	<div class="login-footer">
		V. <?= $setting->system_version; ?> <?= $setting->system_product; ?> | Powered by <a class="login-footer-link" href="<?= $setting->system_vendor_link; ?>" target="_blank"><?= $setting->system_vendor_name; ?></a>
	</div>
</body>
</html>