	...
	<script type="text/javascript">
		...
		function reset() {
			$('#management-name').val("");
			$('#management-job-title').val("");
			$('#management-content').val("");
			$('#management-type-container').dropdown('set selected', "Board of Commisioners");

			$('#management-name-lang').val("");
			$('#management-content-lang').val("");
		...
		function submit() {
			...
			$.ajax({
				...
				type : 'POST',
				url : '<?= base_url() ?>management/ajax_add/',
				xhr: function() {
					var percentage = 0;
					var xhr = new window.XMLHttpRequest();
		...
		<div class="ui stackable one column centered grid">
			<div class="column">
				<div class="ui attached message setting-header">
					<div class="header">Add Management</div>
				</div>
