	...
	<script type="text/javascript">
		...
		function reset() {
			$('#career-name').val("<?= $career->name; ?>");
			$('#career-name-code').val("<?= $career->name_code; ?>");
			$('#career-date').val("<?= $career->date_display; ?>");
			$('#career-date-to').val("<?= $career->date_to_display; ?>");

			$('#career-name-lang').val("<?= $career->name_lang; ?>");
			$('#career-name-code-lang').val("<?= $career->name_code_lang; ?>");

			$('#career-metatag-title').val("<?= $career->metatag_title; ?>");
			$('#career-metatag-author').val("<?= $career->metatag_author; ?>");
			$('#career-metatag-keywords').val("<?= $career->metatag_keywords; ?>");
			$('#career-metatag-description').val("<?= $career->metatag_description; ?>");
		...
		function submit() {
			...
			$.ajax({
				...
				type : 'POST',
				url : '<?= base_url() ?>career/ajax_edit/<?= $career->id; ?>',
				xhr: function() {
					var percentage = 0;
					var xhr = new window.XMLHttpRequest();
		...
		<div class="ui stackable one column centered grid">
			<div class="column">
				<div class="ui attached message setting-header">
					<div class="header">Edit Career</div>
				</div>
					...
					<div class="ui form">
						...
						<div class="field">
							...
							<div class="field">
								...
								<textarea id="career-content" class="form-input" placeholder="Content.." type="text"><?= $career->description; ?></textarea>
							</div>
							<div class="two fields">
								<div class="field">
							...
							<div class="two fields">
								<div class="field">
									...
									<textarea id="career-job-description" class="form-input" placeholder="Job desc.." type="text"><?= $career->job_description; ?></textarea>
								</div>
								<div class="field">
									<label>Qualification <span class="color-red">*</span></label>
									<textarea id="career-qualification" class="form-input" placeholder="Qualification.." type="text"><?= $career->qualification; ?></textarea>
								</div>
							</div>
						</div>
						...
						<div class="field">
							...
							<div class="field">
								<label>Content</label>
								<textarea id="career-content-lang" class="form-input" placeholder="Content.." type="text"><?= $career->description_lang; ?></textarea>
							</div>
							<div class="two fields">
								<div class="field">
									<label>Job Description</label>
									<textarea id="career-job-description-lang" class="form-input" placeholder="Job desc.." type="text"><?= $career->job_description_lang; ?></textarea>
								</div>
								<div class="field">
									<label>Qualification</label>
									<textarea id="career-qualification-lang" class="form-input" placeholder="Qualification.." type="text"><?= $career->qualification_lang; ?></textarea>
								</div>
							</div>
						</div>
