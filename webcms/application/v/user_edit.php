	...
	<script type="text/javascript">
		...
		function reset() {
			...
			<? foreach ($user->arr_user_access as $user_access): ?>
				$('#module-<?= $user_access->module_id ?>-list').prop('checked', true);
				$('#module-<?= $user_access->module_id ?>-add').prop('checked', true);
				$('#module-<?= $user_access->module_id ?>-edit').prop('checked', true);
				$('#module-<?= $user_access->module_id ?>-delete').prop('checked', true);
			<? endforeach; ?>
		}
		...
		<div class="ui stackable one column centered grid">
			<div class="column">
				<div class="ui attached message setting-header">
					<div class="header header-user-access">Edit User</div>
				</div>
