	...
	<script type="text/javascript">
		...
		function reset() {
			...
			$('#product-category-container').dropdown('set selected', "");
			$('#product-corporate-container').dropdown('set selected', "");

			$('#product-description-lang').val("");
					...
					<div class="ui form">
						...
						<div class="two fields">
							<div class="field">
								...
								<textarea id="product-description" class="form-input" placeholder="Description - <?= $setting->setting__system_language; ?>.." type="text"></textarea>
							</div>
							<div class="field">
								<label>Description - <?= $setting->setting__system_language2; ?></label>
								<textarea id="product-description-lang" class="form-input" placeholder="Description - <?= $setting->setting__system_language2; ?>.." type="text"></textarea>
							</div>
						</div>
